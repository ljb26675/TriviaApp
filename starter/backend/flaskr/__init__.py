...
def paginate_questions(request, selection):
  ...
  questions = [question.format() for question in selection if question.question]
...
def create_app(test_config=None):
  ...
  def get_questions():
    ...
    questions = [question for question in Question.query.all() if question.question]      
  ...
  def delete_question(question_id):
    try:
      ...
      question.delete()
      questions = [question for question in Question.query.order_by(Question.id).all() if question.question]
      formatted_qs = paginate_questions(request, questions)
